                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('date_birthday') ? ' has-error' : '' }}">
                            <label for="date_birthday" class="col-md-4 control-label">Date Birthday</label>

                            <div class="col-md-6">
                                <input id="date_birthday" type="date" class="form-control" name="date_birthday" value="{{ old('date_birthday') }}" required autofocus>
